...
#' \code{valide_data} vérifie la validité des données dans un dataframe représentant le fichier des arbres et retourne une liste des erreurs trouvées.
#'
...
#'
#' # La fonction retournera une liste des erreurs trouvées dans le dataframe erreurs
#' }
#'
#' @export
...
#' \code{valide_data_gaules} vérifie la validité des données dans un dataframe représentant le fichier des gaules et retourne une liste des erreurs trouvées.
#'
...
#' Vérifie que les valeurs saisies dans la colonne 'nombre' sont correctes.
#'
#' @param data fichier des arbres
#'
#' @return TRUE ou FALSE s'il détecte des erreurs.
#' # Un dataframe valide
#' valide_Nombre(data)
#' # Devrait retourner TRUE
#'
#' # Un dataframe invalide (colonne 'Nombre' manquante)
#' valide_Nombre(data)
#' # Devrait retourner FALSE
#'
#' # Un dataframe invalide (valeurs négatives)
#' valide_Nombre(data)
#' # Devrait retourner FALSE
#'
#' # Un dataframe invalide (valeurs NA)
#' valide_Nombre(data)
#' # Devrait retourner FALSE
#'
#' @export
...
#' Vérifie si la colonne 'Nombre' dans le fichier de données contient des valeurs valides pour chaque 'Placette'.
...
#'
#' @return TRUE si les valeurs dans la colonne 'Nombre' sont valides pour chaque 'Placette', FALSE sinon.
#'
#' @example
#' # Un dataframe valide
#' valide_Nombre_gaules(data)
#' # Devrait retourner TRUE
#'
#' # Un dataframe invalide (colonne 'Nombre' manquante)
#' valide_Nombre_gaules(data)
...
#' # Devrait retourner FALSE
#'
#' # Un dataframe invalide (somme de 'Nombre' par 'Placette' égale à zéro)
#' valide_Nombre_gaules(data)
#' # Devrait retourner FALSE
#'
#' @export
...
#' Vérifie que les valeurs saisies dans la colonne 'Espece' sont correctes.
#'
#' @param data fichier des arbres
#'
#' @return TRUE ou FALSE s'il détecte des erreurs.
...
#' # Devrait retourner TRUE
#'
#' # Un dataframe invalide (colonne 'Espece' manquante)
#' valide_espece(data)
#' # Devrait retourner FALSE
#'
#' # Un dataframe invalide (valeurs non autorisées)
#' valide_espece(data)
#' # Devrait retourner FALSE
#'
#' # Un dataframe invalide (valeurs NA)
...
valide_espece <- function(data) {
  ...
  valeurs_autorisees <- c(
    "AME", "AUR", "ERE", "ERG", "ERP", "MAS", "OSV", "PRP", "SAL",
...
#' Vérifie que les valeurs saisies dans la colonne 'Etat' sont correctes.
#'
#' @param data fichier des arbres
#'
#' @return TRUE ou FALSE s'il détecte des erreurs.
...
#' # Devrait retourner TRUE
#'
#' # Un dataframe invalide (colonne 'Etat' manquante)
#' valide_Etat(data)
#' # Devrait retourner FALSE
#'
#' # Un dataframe invalide (valeurs non autorisées)
...
#' Vérifie que les valeurs saisies dans la colonne 'DHPcm' sont correctes.
#'
#' @param data fichier des arbres
#'
#' @return TRUE ou FALSE s'il détecte des erreurs.
...
#' # Devrait retourner TRUE
#'
#' # Un dataframe invalide (colonne 'DHPcm' manquante)
#' valide_DHPcm(data)
#' # Devrait retourner FALSE
#'
#' # Un dataframe invalide (valeurs supérieures à 160 cm)
#' valide_DHPcm(data)
#' # Devrait retourner FALSE
#'
#' # Un dataframe invalide (valeurs NA)
...
#' # Devrait retourner FALSE
#'
#' # Un dataframe invalide (valeurs hors de l'intervalle)
#' valide_DHPcm_gaules(data)
#' # Devrait retourner FALSE
#'
#' # Un dataframe invalide (valeurs NA)
...
#' Vérifie que les valeurs saisies dans la colonne 'Vigueur' sont correctes.
#'
#' @param data fichier des arbres
#'
#' @return TRUE ou FALSE s'il détecte des erreurs.
...
#' # Devrait retourner TRUE
#'
#' # Un dataframe invalide (valeurs non autorisées dans 'Vigueur')
#' valide_Vigueur(data)
#' # Devrait retourner FALSE
#'
#' # Un dataframe invalide (valeurs NA sans MSCR correct)
#' valide_Vigueur(data)
#' # Devrait retourner FALSE
#'
#' @export
valide_Vigueur <- function(data) {
  ...
  Espece_specifiques_1_4 <- c(
    "BOG", "BOJ", "BOP",
    "CAC", "CAF", "CAR", "CEO", "CET", "CHB", "CHE", "CHG", "CHR",
    "ERA", "ERG", "ERN", "ERP", "ERR", "ERS",
    "FRA", "FRN", "FRP",
    "HEG",
    "JUV",
    "MAS",
...
#' Vérifier que les valeurs saisies dans la colonne 'Sup_PE' sont correctes.
#'
#' @param data fichier des arbres
#'
#' @return TRUE ou FALSE s'il détecte des erreurs.
...
#' # Devrait retourner TRUE
#'
#' # Un dataframe invalide (colonne 'Sup_PE' manquante)
#' valide_Sup_PE(data)
#' # Devrait retourner FALSE
#'
#' # Un dataframe invalide (valeurs en dehors de l'intervalle)
#' valide_Sup_PE(data)
#' # Devrait retourner FALSE
#'
#' # Un dataframe invalide (valeurs NA)
...
#' # Devrait retourner FALSE
#'
#' # Un dataframe invalide (plusieurs valeurs différentes pour 'Sup_PE' par 'Placette')
#' valide_Sup_PE(data)
#' # Devrait retourner FALSE
#'
#' @export
...
#' Vérifie que les valeurs saisies dans la colonne 'Sup_PE' sont correctes.
#'
#' @param data fichier des gaules
#'
#' @return TRUE ou FALSE s'il détecte des erreurs.
...
#' Vérifie que les valeurs saisies dans la colonne 'Annee_Coupe' sont correctes.
#'
#' @param data fichier des arbres
#'
#' @return TRUE ou FALSE s'il détecte des erreurs.
...
#' @example
#' # Un dataframe valide
#' valide_Annee_Coupe(data)
#' # Devrait retourner TRUE
#'
#' # Un dataframe invalide (colonne 'Annee_Coupe' manquante)
#' valide_Annee_Coupe(data)
#' # Devrait retourner FALSE
#'
#' # Un dataframe invalide (valeurs en dehors de l'intervalle)
...
#' # Devrait retourner FALSE
#'
#' # Un dataframe valide (toutes les valeurs de 'Annee_Coupe' sont NA pour une 'Placette')
#' valide_Annee_Coupe(data)
#' # Devrait retourner TRUE
#'
#' @export
...
#' Vérifie que les valeurs saisies dans la colonne 'Latitude' sont correctes.
#'
#' @param data fichier des arbres
#'
#' @return TRUE ou FALSE s'il détecte des erreurs.
...
#' # Devrait retourner TRUE
#'
#' # Un dataframe invalide (colonne 'Latitude' manquante)
#' valide_Latitude(data)
#' # Devrait retourner FALSE
#'
#' # Un dataframe invalide (valeurs en dehors de l'intervalle)
...
#' # Devrait retourner FALSE
#'
#' # Un dataframe invalide (plusieurs valeurs différentes pour 'Latitude' par 'Placette')
#' valide_Latitude(data)
#' # Devrait retourner FALSE
#'
#' @export
...
#' Vérifie que les valeurs saisies dans la colonne 'Longitude' sont correctes.
#'
#' @param data fichier des arbres
#'
#' @return TRUE ou FALSE s'il détecte des erreurs.
...
#' @example
#' # Un dataframe valide
#' valide_Longitude(data)
#' # Devrait retourner TRUE
#'
#' # Un dataframe invalide (colonne 'Longitude' manquante)
#' valide_Longitude(data)
#' # Devrait retourner FALSE
#'
#' # Un dataframe invalide (valeurs en dehors de l'intervalle)
...
#' # Devrait retourner FALSE
#'
#' # Un dataframe invalide (plusieurs valeurs différentes pour 'Longitude' par 'Placette')
#' valide_Longitude(data)
#' # Devrait retourner FALSE
#'
#' @export
...
#' Vérifie que les valeurs saisies dans la colonne 'Altitude' sont correctes.
#'
#' @param data fichier des arbres
#'
#' @return TRUE ou FALSE s'il détecte des erreurs.
...
#' @example
#' # Un dataframe valide
#' valide_Altitude(data)
#' # Devrait retourner TRUE
#'
#' # Un dataframe invalide (colonne 'Altitude' manquante)
#' valide_Altitude(data)
#' # Devrait retourner FALSE
#'
#' # Un dataframe invalide (valeurs en dehors de l'intervalle)
...
#' # Devrait retourner FALSE
#'
#' # Un dataframe invalide (plusieurs valeurs différentes pour 'Altitude' par 'Placette')
#' valide_Altitude(data)
#' # Devrait retourner FALSE
#'
#' @export
...
#' Vérifie que les valeurs saisies dans la colonne 'Ptot' sont correctes.
#'
#' @param data fichier des arbres
#'
#' @return TRUE ou FALSE s'il détecte des erreurs.
...
#' # Devrait retourner TRUE
#'
#' # Un dataframe invalide (colonne 'Ptot' manquante)
#' valide_Ptot(data)
#' # Devrait retourner FALSE
#'
#' # Un dataframe invalide (valeurs en dehors de l'intervalle)
...
#' # Devrait retourner FALSE
#'
#' # Un dataframe invalide (plusieurs valeurs différentes pour 'Ptot' par 'Placette')
#' valide_Ptot(data)
#' # Devrait retourner FALSE
#'
#' @export
...
#' Vérifie que les valeurs saisies dans la colonne 'Tmoy' sont correctes.
#'
#' @param data fichier des arbres
#'
#' @return TRUE ou FALSE s'il détecte des erreurs.
...
#' # Devrait retourner TRUE
#'
#' # Un dataframe invalide (colonne 'Tmoy' manquante)
#' valide_Tmoy(data)
#' # Devrait retourner FALSE
#'
#' # Un dataframe invalide (valeurs en dehors de l'intervalle)
...
#' # Devrait retourner FALSE
#'
#' # Un dataframe invalide (plusieurs valeurs différentes pour 'Tmoy' par 'Placette')
#' valide_Tmoy(data)
#' # Devrait retourner FALSE
#'
#' @export
...
#' Vérifie que les valeurs saisies dans la colonne 'Type_Eco' sont correctes.
#'
#' @param data fichier des arbres
#'
#' @return TRUE ou FALSE s'il détecte des erreurs.
...
#' @example
#' # Un dataframe valide
#' valide_Type_Eco(data)
#' # Devrait retourner TRUE
#'
#' # Un dataframe invalide (colonne 'Type_Eco' manquante)
#' valide_Type_Eco(data)
#' # Devrait retourner FALSE
#'
#' # Un dataframe invalide (valeurs non autorisées)
...
#' # Devrait retourner FALSE
#'
#' # Un dataframe invalide (plusieurs valeurs différentes pour 'Type_Eco' par 'Placette')
#' valide_Type_Eco(data)
#' # Devrait retourner FALSE
#'
#' @export
...
#' Vérifie que les valeurs saisies dans la colonne 'Reg_Eco' sont correctes.
#'
#' @param data fichier des arbres
#'
#' @return TRUE ou FALSE s'il détecte des erreurs.
...
#' # Devrait retourner TRUE
#'
#' # Un dataframe invalide (colonne 'Reg_Eco' manquante)
#' valide_Reg_Eco(data)
#' # Devrait retourner FALSE
#'
#' # Un dataframe invalide (valeurs non autorisées)
...
#' # Devrait retourner FALSE
#'
#' # Un dataframe invalide (plusieurs valeurs différentes pour 'Reg_Eco' par 'Placette')
#' valide_Reg_Eco(data)
#' # Devrait retourner FALSE
#'
#' @export
valide_Reg_Eco <- function(data) {
  ...
  valeurs_autorisees <- c(
    "1a", "2a", "2b", "2c", "3a", "3b", "3c", "3d", "4a", "4b", "4c", "4d", "4e", "4f", "4g",
    "4h", "DU", "SV"
  )
...
#' Vérifie que les valeurs saisies dans la colonne 'MSCR' sont correctes.
#'
#' @param data fichier des arbres
#'
#' @return TRUE ou FALSE s'il détecte des erreurs.
...
#' # Devrait retourner TRUE
#'
#' # Un dataframe invalide (colonne 'MSCR' manquante)
#' valide_MSCR(data)
#' # Devrait retourner FALSE
#'
#' # Un dataframe invalide (valeurs non autorisées dans 'MSCR')
#' valide_MSCR(data)
#' # Devrait retourner FALSE
#'
#' # Un dataframe invalide (valeurs NA dans 'MSCR' sans 'Vigueur' appropriée)
#' valide_MSCR(data)
#' # Devrait retourner FALSE
#'
#' @export
...
#' Vérifie que les valeurs saisies dans la colonne 'ABCD' sont correctes.
#'
#' @param data fichier des arbres
#'
#' @return TRUE ou FALSE s'il détecte des erreurs.
...
#' # Devrait retourner TRUE
#'
#' # Un dataframe invalide (colonne 'ABCD' manquante)
#' valide_ABCD(data)
#' # Devrait retourner FALSE
#'
#' # Un dataframe invalide (valeurs non autorisées dans 'ABCD')
#' valide_ABCD(data)
#' # Devrait retourner FALSE
#'
#' # Un dataframe invalide (valeurs NA dans 'DHPcm' ou 'Espece')
#' valide_ABCD(data)
#' # Devrait retourner FALSE
#'
#' # Un dataframe invalide (conditions spécifiques non respectées)
#' valide_ABCD(data)
#' # Devrait retourner FALSE
#'
#' @export
...
#' Vérifie que les valeurs saisies dans la colonne 'Pente' sont correctes.
#'
#' @param data fichier des arbres
#'
#' @return TRUE ou FALSE s'il détecte des erreurs.
...
#' # Devrait retourner TRUE
#'
#' # Un dataframe invalide (colonne 'Pente' manquante)
#' valide_Pente(data)
#' # Devrait retourner FALSE
#'
#' # Un dataframe invalide (valeurs en dehors de l'intervalle)
...
#' # Devrait retourner FALSE
#'
#' # Un dataframe invalide (plusieurs valeurs différentes pour 'Pente' par 'Placette')
#' valide_Pente(data)
#' # Devrait retourner FALSE
#'
#' @export
...
#' Vérifie que les valeurs saisies dans la colonne 'GrwDays' sont correctes.
#'
#' @param data fichier des arbres
#'
#' @return TRUE ou FALSE s'il détecte des erreurs.
...
#' # Devrait retourner TRUE
#'
#' # Un dataframe invalide (colonne 'GrwDays' manquante)
#' valide_GrwDays(data)
#' # Devrait retourner FALSE
#'
#' # Un dataframe invalide (valeurs en dehors de l'intervalle)
...
#' # Devrait retourner FALSE
#'
#' # Un dataframe invalide (plusieurs valeurs différentes pour 'GrwDays' par 'Placette')
#' valide_GrwDays(data)
#' # Devrait retourner FALSE
#'
#' @export
...
#' Vérifie que les valeurs saisies dans la colonne 'ntrt' sont correctes.
#'
#' @param data fichier des arbres
#'
#' @return TRUE ou FALSE s'il détecte des erreurs.
...
#' # Devrait retourner TRUE
#'
#' # Un dataframe invalide (colonne 'ntrt' manquante)
#' valide_ntrt(data)
#' # Devrait retourner FALSE
#'
#' # Un dataframe invalide (valeurs non autorisées dans 'ntrt')
#' valide_ntrt(data)
#' # Devrait retourner FALSE
#'
#' # Un dataframe invalide (plusieurs valeurs différentes pour 'ntrt' par 'Placette')
#' valide_ntrt(data)
#' # Devrait retourner FALSE
#'
#' @export
...
#' Vérifie que chaque arbres est unique dans chaque placette
#'
#' @param data fichier des arbres
#'
#' @return TRUE ou FALSE s'il y a des arbres qui se répètent.
#'
#' @example
#'  # Un dataframe valide
#' verifier_arbre_uniques_par_placette(data)
#' # Devrait retourner TRUE
#'
#' # Un dataframe invalide (colonne 'NoArbre' manquante)
#' verifier_arbre_uniques_par_placette(data)
#' # Devrait retourner FALSE
#'
#' # Un dataframe invalide (valeurs NA dans 'Placette' ou 'NoArbre')
#' verifier_arbre_uniques_par_placette(data)
#' # Devrait retourner FALSE
#'
#' # Un dataframe invalide (arbres non uniques dans une placette)
#' verifier_arbre_uniques_par_placette(data)
#' # Devrait retourner FALSE
#'
#' @export
