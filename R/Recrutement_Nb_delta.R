#' Prevoit le paramètre delta de la fonction Weibull qui est la deuxième portion du modèles zero-inflated du nombre de recrues de SaMARE.
#'
...
rec_delta <- function(Rec, st_tot0, type_pe_Plac, ntrt, t0_aj_, Iterj, Para.rec_n) {
  ...
  ParaRec_delta <- Para.rec_n %>% filter(Iter == Iterj & response == "delta")
