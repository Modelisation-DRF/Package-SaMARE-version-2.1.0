...
test_that("simulateur SaMARE return the expected data with Gaules  MCH=1", {
  set.seed(NULL)
  set.seed(3)
...
test_that("simulateur SaMARE return the expected data with coupe and without Gaules MCH=0", {
  set.seed(NULL)
  set.seed(3)
