test_that("Recrutement_Nb_pi_Gaules return the expected data", {
  ...
  expect_Result_test_Recrutement_Nb_pi_Gaules <- readRDS(test_path("fixtures", "expect_Result_test_Recrutement_Nb_pi_Gaules.rds"))
