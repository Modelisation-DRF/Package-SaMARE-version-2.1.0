test_that("test-Recrutement_Produit work", {
  ...
  actual <- rec_prod(RecSelect = RecSelect_test, type_pe_Plac = "type0", rid1 = "3b", Iterj = 1L, Para.rec_prod = Para.rec_prod_test)
  ...
  expected <- data.frame(V1 = expectResult_Produit_test)
